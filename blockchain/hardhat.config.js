...
module.exports = {
  ...
  chainweb: {
    kadenaTestnet: {
      ...
      externalHostUrl:
        'https://evm-testnet.chainweb.com/chainweb/0.0/evm-testnet/chain/20/evm',
      etherscan: {
        apiKey: 'noapikeyrequired',
        apiURLTemplate:
          'https://evm-testnet.chainweb.com/chainweb/0.0/evm-testnet/chain/{cid}/evm/api/',
        browserURLTemplate:
          'https://evm-testnet.chainweb.com/chainweb/0.0/evm-testnet/chain/{cid}/evm/',
      },
    },
  },
